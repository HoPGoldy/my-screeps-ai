import { StructureShortcutKey } from '@/modulesRoom/shortcut'
import {
    DestinationTarget, MoveTargetInfo, ManagerState, TaskFinishReason, ManagerWorkContext, TransportRequestData,
    TransportContext, ManagerActionStrategy
} from '../types'
...
export const usePutResource = function (context: TransportContext): ManagerActionStrategy {
     ...
     */
    const getTarget = function (request: TransportRequestData, context: ManagerWorkContext): ERR_FULL | ERR_INVALID_ARGS | MoveTargetInfo {
    ...
    return (context: ManagerWorkContext) => {
